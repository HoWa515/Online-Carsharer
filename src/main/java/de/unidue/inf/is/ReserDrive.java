...
public class ReserDrive extends HttpServlet {

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String method=request.getParameter("method");
        String id_reserStr=request.getParameter("id_reser");// para used in show  reser
        int id_reser=Integer.parseInt(id_reserStr);
        ...
        case "show": //para show is from "view_haupt"
        	...
        	Fahrt f=fstore.findThisFahrt(id_reser);
